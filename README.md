...
git clone https://github.com/YourUsername/HybridCipher.git
...
Code Explanation
Functions
caesar_cipher(text, key, encrypt=True):
...
hybrid_encrypt(text, caesar_key, rail_rails):

Applies Caesar Cipher Encryption followed by Rail Fence Encryption.
hybrid_decrypt(text, caesar_key, rail_rails):
